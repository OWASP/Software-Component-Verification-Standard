...
Risk-managing the software supply chain is important to reduce the surface area of systems vulnerable to exploits of
outdated components, software dependency attacks and technical debt as a barrier to remediation. 
...
Determination of risk acceptance criteria is not a problem that can be solved by enterprise software: it is up to risk
